...
const handleContactSubmit = async (event) => {
  ...
  //   }
    console.log('Contact form submitted:', { message: contactMessage });
    alert('Support ticket submitted! (Simulation)');
    setContactMessage(''); 
};
...
const handleFeedbackSubmit = async (event) => {
    event.preventDefault();
    if (!feedbackMessage.trim()) return alert('Please enter feedback.');
  ...
  //   }
    console.log('Feedback form submitted:', { feedback: feedbackMessage });
    alert('Thank you for your feedback!');
    setFeedbackMessage('');
